...
public class PageDefine {
    ...
    final static public String DEFAULT_YOUTUBE_AMOUNT = "8";
    final static public String DEFAULT_YOUTUBE_LIKE_AMOUNT = "4";
    final static public String DEFAULT_MEMBER_AMOUNT = "10";
